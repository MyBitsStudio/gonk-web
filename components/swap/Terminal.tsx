    ...
    function checkQuote(){
        ...
        async function check() {
            await jupiterApi.quoteGet({
                ...
                outputMint: "6BTLQF6WGVJfThHoWqX2WDecCWiaiJj52Sw9kQkHpump",
            ...
            <div className="lg:grid lg:grid-cols-2 lg:mx-12">
                    ...
                    {useIsMobile() ? (
                        <div id="dexscreener-embed">
                            <iframe height={500} width={420}
                                    src="https://dexscreener.com/solana/6BTLQF6WGVJfThHoWqX2WDecCWiaiJj52Sw9kQkHpump?embed=1&theme=dark&info=0"></iframe>
                        </div>
                    ) : (
                        <div id="dexscreener-embed">
                ...
                <div className="max-w-xl lg:max-w-3xl">
                    ...
                    {connected ? (
                                        ...
                                        <div>
                                            ...
                                            >
                                                <input
                                                    type="text"
                                                    id="sol"
                                                    className="peer border-none bg-transparent placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 text-white"
                                                    placeholder="SOL"
                                                    onChange={(e) => {
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li className={"flex justify-center "}>
                                                                                <button onClick={purchase}
                                                                                        className={"inline-block shrink-0 rounded-md border border-green-700 bg-green-400 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500"}> Swap
                                                                                    Now
                                                                                </button>
                                                                            </li>
                                                                        </ul>
                        ...
                        <div className="flex rounded border border-green-700 bg-gray-800 p-2 items-center justify-center">
                            <WalletMultiButton className={"btn btn-outline btn-success"}/>
                        </div>
                        )}
                </div>
                </div>
